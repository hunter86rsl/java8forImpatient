...
public class NumberDemo {
    ...
    public static void main(String[] args) {
        System.out.println(4000000000L); // liczba całkowita (long)
        System.out.println(0xCAFEBABE); // liczba szesnastkowa
        System.out.println(0b1001); // liczba dwójkowa
        System.out.println(011); // liczba ósemkowa
        System.out.println();
        // Podkreślenia
        ...
        System.out.println();
        // Zaawansowane: wartość bez znaku
        ...
        System.out.println();
        // Wartości nieskończone i NaN ('nie-liczba')
